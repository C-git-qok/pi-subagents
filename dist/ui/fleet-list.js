...
export class FleetList {
    ...
    agentRecords() {
        ...
        return this.manager.listAgents()
            .filter(a => isTopLevelAgent(a) && a.session && (a.status === "running" || a.status === "queued"
    ...
    openSelected() {
        ...
        if (entry.kind === "workflow") {
            ...
            void Promise.resolve(this.openWorkflow?.(entry.workflow.id)).then(() => this.clearViewer(), () => this.clearViewer());
            return;
        }
