...
export declare function journalKey(input: JournalKeyInput): string;
/**
 ...
 */
export declare function readJournal(path: string): WorkflowJournalEntry[];
/** Append one settled call. Failure to write is not failure to run. */
export declare function appendJournal(path: string, entry: WorkflowJournalEntry): void;
