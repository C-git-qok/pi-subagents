...
export declare function getLifetimeCost(u?: LifetimeUsage): number;
 ...
 */
export declare function toReportedUsage(u: LifetimeUsage): ReportedUsage | undefined;
/**
 ...
 */
export declare class PendingUsagePool {
    private pending;
    private dirty;
