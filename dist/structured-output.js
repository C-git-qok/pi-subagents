...
export function createStructuredCapture() {
    return { called: false };
}
/**
 ...
 */
export function createStructuredOutputTool(compiled, capture) {
    return defineTool({
        name: STRUCTURED_OUTPUT_TOOL_NAME,
        label: "Structured Output",
        description: "Report your final answer. Call this exactly once, with the complete result, and put everything the "
 ...
 */
export function structuredRetryPrompt(capture) {
