...
export const projectAgentsDir = (cwd = process.cwd()) => join(cwd, ".pi", "agents");
export const workspaceAgentsDir = (cwd = process.cwd()) => join(cwd, ".agents", "agents");
 ...
 * isn't reading.
 */
export function findAgentFile(name, cwd = process.cwd()) {
 ...
 */
export function locateAgentFile(name, sourcePath, cwd = process.cwd()) {
 ...
 */
export function isDisabledContent(content) {
    try {
 ...
 */
export function disableInContent(content) {
 ...
 */
export function enableInContent(content) {
    const block = splitFrontmatter(content);
    if (!block)
...
export function isEmptyStub(content) {
 ...
 */
export function buildNewAgentFile(input) {
...
export function serializeAgentFile(cfg) {
    const fmFields = [];
